...
- [Open Deep Research (Web UI)](https://github.com/extracurricular-ai/open-deep-research-with-web-ui): Self-hostable deep research agent built on smolagents, with a real-time web UI, parallel background tasks, LLM-based context compaction, and multi-provider search (DDGS/Tavily/SerpAPI/MetaSo/Bocha) with auto-fallback. ![GitHub Repo stars](https://img.shields.io/github/stars/extracurricular-ai/open-deep-research-with-web-ui?style=social)
